...
const BADGE_DEFS = [
  ...
  { id: "streak_3", label: "On a Roll", desc: "3-day streak", icon: "Party" },
  {
    id: "streak_7",
    label: "Week Warrior",
    desc: "7-day streak",
  ...
  },
  {
    id: "perfect_week",
    label: "Perfect Week",
    desc: "100% for 7 consecutive days",
    icon: "Star",
  },
  {
    id: "perfect_month",
    label: "Perfect Month",
    desc: "100% for 30 consecutive days",
    icon: "Moon",
  },
  {
    id: "perfect_quarter",
    label: "Perfect Quarter",
    desc: "100% for 90 consecutive days",
    icon: "Sun",
  },
  {
    id: "consistency_60",
    label: "On Track",
    desc: "60%+ over 30 days",
    icon: "Activity",
  },
  {
    id: "consistency_80",
    label: "Consistent",
    desc: "80%+ over 30 days",
    icon: "Crosshair",
  },
  {
    id: "consistency_95",
    label: "Consistency King",
    desc: "95%+ over 30 days",
    icon: "Award",
  },
  {
    id: "total_10",
    label: "Steady Pace",
    desc: "10 total completions",
    icon: "TrendingUp",
  },
  {
    id: "total_30",
    label: "Dedicated",
    desc: "30 total completions",
    icon: "Trophy",
  },
  {
    id: "total_50",
    label: "Halfway Hero",
    desc: "50 total completions",
    icon: "Award",
  },
  {
    id: "total_100",
  ...
  {
    id: "total_200",
    label: "Double Centurion",
    desc: "200 total completions",
    icon: "Diamond",
  },
  {
    id: "total_500",
    label: "Relentless",
    desc: "500 total completions",
    icon: "Crosshair",
  },
  {
    id: "total_1000",
    label: "Unstoppable",
    desc: "1000 total completions",
    icon: "Award",
  },
  {
    id: "first_skip",
    label: "Self-Care",
    desc: "Used a skip token wisely",
    icon: "Heart",
  },
  {
    id: "skip_5",
    label: "Balanced Soul",
    desc: "Used 5 skip tokens wisely",
    icon: "Feather",
  },
  {
    id: "morning_10",
    label: "Early Bird",
    desc: "10 morning completions",
    icon: "Sunrise",
  },
  {
    id: "evening_10",
    label: "Night Owl",
    desc: "10 evening completions",
    icon: "Moon",
  },
  {
    id: "habit_5",
    label: "Habit Enthusiast",
    desc: "Created 5 habits",
    icon: "Book",
  },
  {
    id: "habit_10",
    label: "Habit Architect",
    desc: "Created 10 habits",
    icon: "Tool",
  },
  {
    id: "time_variety",
    label: "Well-Rounded",
    desc: "Habits in all 3 time slots",
    icon: "Layers",
  },
  {
    id: "cadence_variety",
    label: "Versatile",
    desc: "3+ different schedule types",
    icon: "Settings",
  },
  {
    id: "archive_first",
    label: "Fresh Start",
    desc: "Archived a habit",
    icon: "Trash2",
  },
];
...
export function checkBadges(habit) {
  ...
  if (habit.timeOfDay === "morning" && doneCount >= 10)
    earned.push("morning_10");
  if (habit.timeOfDay === "evening" && doneCount >= 10)
    earned.push("evening_10");
...
export function checkGlobalBadges(habits) {
  ...
  if (
    timeSlots.has("morning") &&
    timeSlots.has("afternoon") &&
    timeSlots.has("evening")
  ) {
    earned.push("time_variety");
  }

  const cadenceTypes = new Set(
    active.map((h) => h.cadence?.type).filter(Boolean),
  );
